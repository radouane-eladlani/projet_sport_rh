...
if missing_rh > 0:
    ...
    print(f"ATTENTION : {missing_rh} activités sont liées à des salariés absents du référentiel RH (Jointure impossible).")
...
if fraudes.count() > 0:
    ...
    print("Détail des fraudes détectées (exemple) :")
